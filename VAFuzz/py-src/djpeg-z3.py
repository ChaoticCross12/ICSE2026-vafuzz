...
options = {
    'vafuzz_opt_0': Option('vafuzz_opt_0', 'int', '-', ' ', range_l=0, range_h=100),
    ...
    'vafuzz_opt_11': Option('vafuzz_opt_11', 'choice', '-', ' ', choices=['vafuzz_opt_11_choice_0', 'vafuzz_opt_11_choice_1', 'vafuzz_opt_11_choice_2']),
    'vafuzz_opt_12': Option('vafuzz_opt_12', 'choice', '-', ' ', choices=['vafuzz_opt_12_choice_0', 'vafuzz_opt_12_choice_1', 'vafuzz_opt_12_choice_2']),
    'vafuzz_opt_13': Option('vafuzz_opt_13', 'bool', '-', '='),
    'vafuzz_opt_14': Option('vafuzz_opt_14', 'bool', '-', '='),
    'vafuzz_opt_15': Option('vafuzz_opt_15', 'int', '-', ' ', range_l=0, range_h=100),
    'vafuzz_opt_16': Option('vafuzz_opt_16', 'int', '-', ' ', range_l=0, range_h=100),
...
opt_name_map = {
    ...
    'vafuzz_opt_10': 'targa',
    'vafuzz_opt_11': 'dct',
    'vafuzz_opt_12': 'dither',
    'vafuzz_opt_13': 'nosmooth',
    'vafuzz_opt_14': 'onepass',
    'vafuzz_opt_15': 'maxmemory',
    'vafuzz_opt_16': 'maxscans',
    'vafuzz_opt_17': 'memsrc',
    'vafuzz_opt_18': 'report',
    'vafuzz_opt_19': 'strict',
    'vafuzz_opt_20': 'verbose',
    'vafuzz_opt_21': 'debug',
}
...
opt_name_revert_map = {
    ...
    'targa': 'vafuzz_opt_10',
    'dct': 'vafuzz_opt_11',
    'dither': 'vafuzz_opt_12',
    'nosmooth': 'vafuzz_opt_13',
    'onepass': 'vafuzz_opt_14',
    'maxmemory': 'vafuzz_opt_15',
    'maxscans': 'vafuzz_opt_16',
    'memsrc': 'vafuzz_opt_17',
    'report': 'vafuzz_opt_18',
    'strict': 'vafuzz_opt_19',
    'verbose': 'vafuzz_opt_20',
    'debug': 'vafuzz_opt_21',
}
...
choice_map = {
    'vafuzz_opt_11_choice_0': 'int',
    'vafuzz_opt_11_choice_1': 'fast',
    'vafuzz_opt_11_choice_2': 'float',
    'vafuzz_opt_12_choice_0': 'fs',
    'vafuzz_opt_12_choice_1': 'none',
    'vafuzz_opt_12_choice_2': 'ordered',
}

choice_map_keys = sorted(choice_map.keys(), reverse=True)

choice_revert_map = {
    'int': 'vafuzz_opt_11_choice_0',
    'fast': 'vafuzz_opt_11_choice_1',
    'float': 'vafuzz_opt_11_choice_2',
    'fs': 'vafuzz_opt_12_choice_0',
    'none': 'vafuzz_opt_12_choice_1',
    'ordered': 'vafuzz_opt_12_choice_2',
}
