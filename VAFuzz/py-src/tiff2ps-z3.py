...
options = {
    ...
    'vafuzz_opt_5': Option('vafuzz_opt_5', 'real', '-', ' ', range_l=0, range_h=20),
    'vafuzz_opt_6': Option('vafuzz_opt_6', 'bool', '-', '='),
    'vafuzz_opt_7': Option('vafuzz_opt_7', 'int', '-', ' ', range_l=0, range_h=10),
    'vafuzz_opt_8': Option('vafuzz_opt_8', 'bool', '-', '='),
    'vafuzz_opt_9': Option('vafuzz_opt_9', 'bool', '-', '='),
    'vafuzz_opt_10': Option('vafuzz_opt_10', 'real', '-', ' ', range_l=0, range_h=100),
    'vafuzz_opt_11': Option('vafuzz_opt_11', 'real', '-', ' ', range_l=0, range_h=100),
    'vafuzz_opt_12': Option('vafuzz_opt_12', 'real', '-', ' ', range_l=0, range_h=100),
    'vafuzz_opt_13': Option('vafuzz_opt_13', 'real', '-', ' ', range_l=0, range_h=100),
    'vafuzz_opt_14': Option('vafuzz_opt_14', 'real', '-', ' ', range_l=0, range_h=10),
    'vafuzz_opt_15': Option('vafuzz_opt_15', 'int', '-', ' ', range_l=0, range_h=9),
    'vafuzz_opt_16': Option('vafuzz_opt_16', 'real', '-', ' ', range_l=0, range_h=20),
    'vafuzz_opt_17': Option('vafuzz_opt_17', 'bool', '-', '='),
    'vafuzz_opt_18': Option('vafuzz_opt_18', 'int', '-', ' ', range_l=0, range_h=16384),
    'vafuzz_opt_19': Option('vafuzz_opt_19', 'int', '-', ' ', range_l=0, range_h=100),
    'vafuzz_opt_20': Option('vafuzz_opt_20', 'bool', '-', '='),
    'vafuzz_opt_21': Option('vafuzz_opt_21', 'choice', '-', ' ', choices=['vafuzz_opt_21_choice_0', 'vafuzz_opt_21_choice_1']),
    'vafuzz_opt_22': Option('vafuzz_opt_22', 'choice', '-', ' ', choices=['vafuzz_opt_22_choice_0', 'vafuzz_opt_22_choice_1', 'vafuzz_opt_22_choice_2', 'vafuzz_opt_22_choice_3']),
...
choice_map = {
    'vafuzz_opt_21_choice_0': 'L',
    'vafuzz_opt_21_choice_1': 'P',
    'vafuzz_opt_22_choice_0': '90',
    'vafuzz_opt_22_choice_1': '180',
    'vafuzz_opt_22_choice_2': '270',
    'vafuzz_opt_22_choice_3': 'auto',
}

choice_map_keys = sorted(choice_map.keys(), reverse=True)

choice_revert_map = {
    'L': 'vafuzz_opt_21_choice_0',
    'P': 'vafuzz_opt_21_choice_1',
    '90': 'vafuzz_opt_22_choice_0',
    '180': 'vafuzz_opt_22_choice_1',
    '270': 'vafuzz_opt_22_choice_2',
    'auto': 'vafuzz_opt_22_choice_3',
}
