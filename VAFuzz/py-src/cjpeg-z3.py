...
options = {
    ...
    'vafuzz_opt_10': Option('vafuzz_opt_10', 'choice', '-', ' ', choices=['vafuzz_opt_10_choice_0', 'vafuzz_opt_10_choice_1', 'vafuzz_opt_10_choice_2']),
    'vafuzz_opt_11': Option('vafuzz_opt_11', 'int', '-', ' ', range_l=1, range_h=100),
    'vafuzz_opt_12': Option('vafuzz_opt_12', 'int', '-', ' ', range_l=1, range_h=100),
    'vafuzz_opt_13': Option('vafuzz_opt_13', 'int', '-', ' ', range_l=1, range_h=100),
...
opt_name_map = {
    'vafuzz_opt_0': 'quality',
    'vafuzz_opt_1': 'grayscale',
    'vafuzz_opt_2': 'rgb',
    'vafuzz_opt_3': 'optimize',
    'vafuzz_opt_4': 'progressive',
    'vafuzz_opt_5': 'targa',
    'vafuzz_opt_6': 'precision 8',
    'vafuzz_opt_7': 'precision 12',
    'vafuzz_opt_8': 'precision 16',
    'vafuzz_opt_9': 'arithmetic',
    'vafuzz_opt_10': 'dct',
    'vafuzz_opt_11': 'restart',
    'vafuzz_opt_12': 'smooth',
    'vafuzz_opt_13': 'maxmemory',
    'vafuzz_opt_14': 'memdst',
    'vafuzz_opt_15': 'report',
    'vafuzz_opt_16': 'strict',
    'vafuzz_opt_17': 'verbose',
    'vafuzz_opt_18': 'debug',
    'vafuzz_opt_19': 'baseline',
}

opt_name_map_keys = sorted(opt_name_map.keys(), reverse=True)

opt_name_revert_map = {
    'quality': 'vafuzz_opt_0',
    'grayscale': 'vafuzz_opt_1',
    'rgb': 'vafuzz_opt_2',
    'optimize': 'vafuzz_opt_3',
    'progressive': 'vafuzz_opt_4',
    'targa': 'vafuzz_opt_5',
    'precision 8': 'vafuzz_opt_6',
    'precision 12': 'vafuzz_opt_7',
    'precision 16': 'vafuzz_opt_8',
    'arithmetic': 'vafuzz_opt_9',
    'dct': 'vafuzz_opt_10',
    'restart': 'vafuzz_opt_11',
    'smooth': 'vafuzz_opt_12',
    'maxmemory': 'vafuzz_opt_13',
    'memdst': 'vafuzz_opt_14',
    'report': 'vafuzz_opt_15',
    'strict': 'vafuzz_opt_16',
    'verbose': 'vafuzz_opt_17',
    'debug': 'vafuzz_opt_18',
    'baseline': 'vafuzz_opt_19',
}

opt_name_revert_map_keys = sorted(opt_name_revert_map.keys(), reverse=True)

choice_map = {
    'vafuzz_opt_10_choice_0': 'int',
    'vafuzz_opt_10_choice_1': 'fast',
    'vafuzz_opt_10_choice_2': 'float',
}

choice_map_keys = sorted(choice_map.keys(), reverse=True)

choice_revert_map = {
    'int': 'vafuzz_opt_10_choice_0',
    'fast': 'vafuzz_opt_10_choice_1',
    'float': 'vafuzz_opt_10_choice_2',
}
