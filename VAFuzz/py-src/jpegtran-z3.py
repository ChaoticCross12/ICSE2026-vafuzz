...
options = {
    'vafuzz_opt_0': Option('vafuzz_opt_0', 'choice', '-', ' ', choices=['vafuzz_opt_0_choice_0', 'vafuzz_opt_0_choice_1', 'vafuzz_opt_0_choice_2', 'vafuzz_opt_0_choice_3']),
    'vafuzz_opt_1': Option('vafuzz_opt_1', 'bool', '-', '='),
    'vafuzz_opt_2': Option('vafuzz_opt_2', 'bool', '-', '='),
    'vafuzz_opt_3': Option('vafuzz_opt_3', 'choice', '-', ' ', choices=['vafuzz_opt_3_choice_0', 'vafuzz_opt_3_choice_1']),
    'vafuzz_opt_4': Option('vafuzz_opt_4', 'bool', '-', '='),
    'vafuzz_opt_5': Option('vafuzz_opt_5', 'bool', '-', '='),
    'vafuzz_opt_6': Option('vafuzz_opt_6', 'choice', '-', ' ', choices=['vafuzz_opt_6_choice_0', 'vafuzz_opt_6_choice_1', 'vafuzz_opt_6_choice_2']),
    ...
    'vafuzz_opt_11': Option('vafuzz_opt_11', 'int', '-', ' ', range_l=0, range_h=100),
    'vafuzz_opt_12': Option('vafuzz_opt_12', 'int', '-', ' ', range_l=0, range_h=100),
    'vafuzz_opt_13': Option('vafuzz_opt_13', 'int', '-', ' ', range_l=0, range_h=100),
...
opt_name_map = {
    'vafuzz_opt_0': 'copy',
    'vafuzz_opt_1': 'optimize',
    'vafuzz_opt_2': 'progressive',
    'vafuzz_opt_3': 'flip',
    'vafuzz_opt_4': 'grayscale',
    'vafuzz_opt_5': 'perfect',
    'vafuzz_opt_6': 'rotate',
    'vafuzz_opt_7': 'transpose',
    'vafuzz_opt_8': 'transverse',
    'vafuzz_opt_9': 'trim',
    'vafuzz_opt_10': 'arithmetic',
    'vafuzz_opt_11': 'restart',
    'vafuzz_opt_12': 'maxmemory',
    'vafuzz_opt_13': 'maxscans',
    'vafuzz_opt_14': 'report',
    'vafuzz_opt_15': 'strict',
    'vafuzz_opt_16': 'verbose',
    'vafuzz_opt_17': 'debug',
}
...
opt_name_revert_map = {
    'copy': 'vafuzz_opt_0',
    'optimize': 'vafuzz_opt_1',
    'progressive': 'vafuzz_opt_2',
    'flip': 'vafuzz_opt_3',
    'grayscale': 'vafuzz_opt_4',
    'perfect': 'vafuzz_opt_5',
    'rotate': 'vafuzz_opt_6',
    'transpose': 'vafuzz_opt_7',
    'transverse': 'vafuzz_opt_8',
    'trim': 'vafuzz_opt_9',
    'arithmetic': 'vafuzz_opt_10',
    'restart': 'vafuzz_opt_11',
    'maxmemory': 'vafuzz_opt_12',
    'maxscans': 'vafuzz_opt_13',
    'report': 'vafuzz_opt_14',
    'strict': 'vafuzz_opt_15',
    'verbose': 'vafuzz_opt_16',
    'debug': 'vafuzz_opt_17',
}
...
choice_map = {
    'vafuzz_opt_0_choice_0': 'none',
    'vafuzz_opt_0_choice_1': 'comments',
    'vafuzz_opt_0_choice_2': 'icc',
    'vafuzz_opt_0_choice_3': 'all',
    'vafuzz_opt_3_choice_0': 'horizontal',
    'vafuzz_opt_3_choice_1': 'vertical',
    'vafuzz_opt_6_choice_0': '90',
    'vafuzz_opt_6_choice_1': '180',
    'vafuzz_opt_6_choice_2': '270',
}

choice_map_keys = sorted(choice_map.keys(), reverse=True)

choice_revert_map = {
    'none': 'vafuzz_opt_0_choice_0',
    'comments': 'vafuzz_opt_0_choice_1',
    'icc': 'vafuzz_opt_0_choice_2',
    'all': 'vafuzz_opt_0_choice_3',
    'horizontal': 'vafuzz_opt_3_choice_0',
    'vertical': 'vafuzz_opt_3_choice_1',
    '90': 'vafuzz_opt_6_choice_0',
    '180': 'vafuzz_opt_6_choice_1',
    '270': 'vafuzz_opt_6_choice_2',
}
