...
options = {
    ...
    'vafuzz_opt_1': Option('vafuzz_opt_1', 'int', '-', ' ', range_l=1, range_h=100),
    'vafuzz_opt_2': Option('vafuzz_opt_2', 'int', '-', ' ', range_l=1, range_h=100),
    'vafuzz_opt_3': Option('vafuzz_opt_3', 'int', '-', ' ', range_l=1, range_h=100),
    'vafuzz_opt_4': Option('vafuzz_opt_4', 'int', '-', ' ', range_l=1, range_h=100),
    'vafuzz_opt_5': Option('vafuzz_opt_5', 'bool', '-', '='),
    'vafuzz_opt_6': Option('vafuzz_opt_6', 'real', '-', ' ', range_l=0, range_h=1000),
    'vafuzz_opt_7': Option('vafuzz_opt_7', 'real', '-', ' ', range_l=0, range_h=1000),
}
