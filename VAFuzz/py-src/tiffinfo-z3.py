...
options = {
    ...
    'vafuzz_opt_4': Option('vafuzz_opt_4', 'choice', '-', ' ', choices=['vafuzz_opt_4_choice_0', 'vafuzz_opt_4_choice_1']),
    'vafuzz_opt_5': Option('vafuzz_opt_5', 'bool', '-', '='),
    'vafuzz_opt_6': Option('vafuzz_opt_6', 'int', '-', ' ', range_l=0, range_h=100),
...
choice_map = {
    'vafuzz_opt_4_choice_0': 'lsb2msb',
    'vafuzz_opt_4_choice_1': 'msb2lsb',
}

choice_map_keys = sorted(choice_map.keys(), reverse=True)

choice_revert_map = {
    'lsb2msb': 'vafuzz_opt_4_choice_0',
    'msb2lsb': 'vafuzz_opt_4_choice_1',
}
