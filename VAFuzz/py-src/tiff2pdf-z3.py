...
options = {
    ...
    'vafuzz_opt_2': Option('vafuzz_opt_2', 'int', '-', ' ', range_l=1, range_h=10),
    'vafuzz_opt_3': Option('vafuzz_opt_3', 'bool', '-', '='),
    'vafuzz_opt_4': Option('vafuzz_opt_4', 'bool', '-', '='),
    'vafuzz_opt_5': Option('vafuzz_opt_5', 'bool', '-', '='),
    'vafuzz_opt_6': Option('vafuzz_opt_6', 'choice', '-', ' ', choices=['vafuzz_opt_6_choice_0', 'vafuzz_opt_6_choice_1']),
    'vafuzz_opt_7': Option('vafuzz_opt_7', 'int', '-', ' ', range_l=1, range_h=10),
    'vafuzz_opt_8': Option('vafuzz_opt_8', 'int', '-', ' ', range_l=1, range_h=10),
    'vafuzz_opt_9': Option('vafuzz_opt_9', 'int', '-', ' ', range_l=1, range_h=10),
    'vafuzz_opt_10': Option('vafuzz_opt_10', 'int', '-', ' ', range_l=1, range_h=10),
    'vafuzz_opt_11': Option('vafuzz_opt_11', 'choice', '-', ' ', choices=['vafuzz_opt_11_choice_0', 'vafuzz_opt_11_choice_1']),
    'vafuzz_opt_12': Option('vafuzz_opt_12', 'bool', '-', '='),
    'vafuzz_opt_13': Option('vafuzz_opt_13', 'bool', '-', '='),
    'vafuzz_opt_14': Option('vafuzz_opt_14', 'bool', '-', '='),
    'vafuzz_opt_15': Option('vafuzz_opt_15', 'int', '-', ' ', range_l=0, range_h=1024),
}
...
choice_map = {
    'vafuzz_opt_6_choice_0': 'i',
    'vafuzz_opt_6_choice_1': 'm',
    'vafuzz_opt_11_choice_0': 'd',
    'vafuzz_opt_11_choice_1': 'o',
}

choice_map_keys = sorted(choice_map.keys(), reverse=True)

choice_revert_map = {
    'i': 'vafuzz_opt_6_choice_0',
    'm': 'vafuzz_opt_6_choice_1',
    'd': 'vafuzz_opt_11_choice_0',
    'o': 'vafuzz_opt_11_choice_1',
}
