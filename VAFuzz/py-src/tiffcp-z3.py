...
options = {
    ...
    'vafuzz_opt_1': Option('vafuzz_opt_1', 'int', '-', ' ', range_l=0, range_h=100),
    ...
    'vafuzz_opt_14': Option('vafuzz_opt_14', 'int', '-', ' ', range_l=1, range_h=100),
    'vafuzz_opt_15': Option('vafuzz_opt_15', 'int', '-', ' ', range_l=1, range_h=100),
    'vafuzz_opt_16': Option('vafuzz_opt_16', 'choice', '-', ' ', choices=['vafuzz_opt_16_choice_0', 'vafuzz_opt_16_choice_1']),
    'vafuzz_opt_17': Option('vafuzz_opt_17', 'choice', '-', ' ', choices=['vafuzz_opt_17_choice_0', 'vafuzz_opt_17_choice_1', 'vafuzz_opt_17_choice_2', 'vafuzz_opt_17_choice_3', 'vafuzz_opt_17_choice_4', 'vafuzz_opt_17_choice_5', 'vafuzz_opt_17_choice_6', 'vafuzz_opt_17_choice_7', 'vafuzz_opt_17_choice_8']),
}
...
choice_map = {
    'vafuzz_opt_2_choice_0': 'contig',
    'vafuzz_opt_2_choice_1': 'separate',
    'vafuzz_opt_16_choice_0': 'lsb2msb',
    'vafuzz_opt_16_choice_1': 'msb2lsb',
    'vafuzz_opt_17_choice_0': 'lzw',
    'vafuzz_opt_17_choice_1': 'zip',
    'vafuzz_opt_17_choice_2': 'lzma',
    'vafuzz_opt_17_choice_3': 'jpeg',
    'vafuzz_opt_17_choice_4': 'packbits',
    'vafuzz_opt_17_choice_5': 'g3',
    'vafuzz_opt_17_choice_6': 'g4',
    'vafuzz_opt_17_choice_7': 'sgilog',
    'vafuzz_opt_17_choice_8': 'none',
}

choice_map_keys = sorted(choice_map.keys(), reverse=True)

choice_revert_map = {
    'contig': 'vafuzz_opt_2_choice_0',
    'separate': 'vafuzz_opt_2_choice_1',
    'lsb2msb': 'vafuzz_opt_16_choice_0',
    'msb2lsb': 'vafuzz_opt_16_choice_1',
    'lzw': 'vafuzz_opt_17_choice_0',
    'zip': 'vafuzz_opt_17_choice_1',
    'lzma': 'vafuzz_opt_17_choice_2',
    'jpeg': 'vafuzz_opt_17_choice_3',
    'packbits': 'vafuzz_opt_17_choice_4',
    'g3': 'vafuzz_opt_17_choice_5',
    'g4': 'vafuzz_opt_17_choice_6',
    'sgilog': 'vafuzz_opt_17_choice_7',
    'none': 'vafuzz_opt_17_choice_8',
}
