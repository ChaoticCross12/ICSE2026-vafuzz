...
options = {
    ...
    'vafuzz_opt_2': Option('vafuzz_opt_2', 'choice', '-', ' ', choices=['vafuzz_opt_2_choice_0', 'vafuzz_opt_2_choice_1', 'vafuzz_opt_2_choice_2']),
    'vafuzz_opt_3': Option('vafuzz_opt_3', 'int', '-', ' ', range_l=1, range_h=2147483647),
...
choice_map = {
    'vafuzz_opt_2_choice_0': '16',
    'vafuzz_opt_2_choice_1': '32',
    'vafuzz_opt_2_choice_2': '64',
}

choice_map_keys = sorted(choice_map.keys(), reverse=True)

choice_revert_map = {
    '16': 'vafuzz_opt_2_choice_0',
    '32': 'vafuzz_opt_2_choice_1',
    '64': 'vafuzz_opt_2_choice_2',
}
